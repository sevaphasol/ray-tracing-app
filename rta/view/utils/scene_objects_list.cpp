...
rta::view::SceneObjectsListModal::SceneObjectsListModal( hui::WindowManager*  wm,
                                                         float                x,
                                                         float                y,
                                                         float                w,
                                                         float                h,
...
void
rta::view::SceneObjectsListModal::refresh()
{
    if ( !visible_ )
    {
        return;
...
bool
rta::view::SceneObjectsListModal::propagateEventToChildren( const hui::Event& event )
{
    if ( !visible_ )
    {
        return false;
...
void
rta::view::SceneObjectsListModal::RedrawMyTexture() const
{
    if ( !visible_ )
    {
        return;
...
void
rta::view::SceneObjectsListModal::show()
{
    visible_ = true;
    refresh();
}
...
void
rta::view::SceneObjectsListModal::hide()
{
    visible_ = false;
}

bool
rta::view::SceneObjectsListModal::isVisible() const
{
    return visible_;
}

void
rta::view::SceneObjectsListModal::rebuildListItems()
{
    if ( !list_ )
    {
        return;
